...
def reshape_and_normalize_data(train_data, test_data=None, channels=None, normalize=True):
    ...
    """
    #print("trans_channels:", channels)
    # if training data is less than 2D
    run_test = False
    for test, data in enumerate([train_data, test_data]):
        # print("trans_test:",test)
        # print("trans_data:",np.array(data).shape)
        if data is None:
...
def random_rotate_and_resize(X, Y=None, scale_range=1., xy = (224,224), 
    ...
    """
    # print("offset:", Y[0][1:3].shape, Y[0][1:3].max(), Y[0][1:3].min())
    # plt.imshow(plot.dx_to_circ(Y[0][1:3]))
    # plt.axis('off')
    # plt.savefig("/home/yw2009/anaconda3/envs/medicalimage/cellposes/Gseg_2C_levelset_offset/images/offsetmap_gt_tran.png", bbox_inches='tight', pad_inches = 0 )
    # plt.clf()

    # print("centermap:", Y[0][3].shape, Y[0][3].max(), Y[0][3].min())
    # plt.imshow(Y[0][3])
    # plt.axis('off')
    # plt.savefig("/home/yw2009/anaconda3/envs/medicalimage/cellposes/Gseg_2C_levelset_offset/images/centermap_gt_tran.png", bbox_inches='tight', pad_inches = 0 )
    # plt.clf()

    # print("confidence:", Y[0][0].shape, Y[0][0].max(), Y[0][0].min())
    # plt.imshow(Y[0][0])
    # plt.axis('off')
    # plt.savefig("/home/yw2009/anaconda3/envs/medicalimage/cellposes/Gseg_2C_levelset_offset/images/confidencemap_gt_tran.png", bbox_inches='tight', pad_inches = 0 )
    # plt.clf()
